...
```{r, barplot of 5th ratios, fig.width = 12, fig.height = 8}
...
ro.fifth <- order(fifth, decreasing = TRUE)
data.frame(Country, fifth, o.fifth, ro.fifth, fifth[ro.fifth], Country[ro.fifth])
# barplot(fifth[o.fifth])
# barplot(fifth[o.fifth], names.arg = Country[o.fifth])
# barplot(fifth[o.fifth], names.arg = Country[o.fifth],  col = rev(rainbow(nrow(data.21), start = 0, end = 2/3)))
# barplot(fifth[o.fifth], names.arg = Country[o.fifth],  col = rev(rainbow(nrow(data.21), start = 0, end = 2/3)), las = 2)
b.fifth <- barplot(fifth[o.fifth], names.arg = Country[o.fifth], col = rev(rainbow(nrow(data.21), start = 0, end = 2/3)), ylim = c(0, 10), xpd = FALSE, las = 2)
