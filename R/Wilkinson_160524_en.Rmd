...
```{r, barplots, fig.width = 12, fig.height = 8}
...
b.ineq <- barplot(fifth_ratio[o.ineq], names.arg = Country[o.ineq], col = rev(rainbow(23, start = 0, end = 4/6)), las = 2, ylim = c(0, 11))
text(x = b.ineq, y = fifth_ratio[o.ineq] + 0.3, labels = format(fifth_ratio[o.ineq], digits = 2), cex = 0.8)
```
...
상관계수 r = `r cor.1` 를 도표 안에 표시하고 별도의 파일로 출력하려면,

```{r, correlation kr,  fig.width=8, fig.height=6}
# par(family = "Gulim")
plot(Index_inequality.df, pch = 20, col = "red", xlim = c(3, 9), ylim = c(-1.5, 2.5), ann = FALSE)
