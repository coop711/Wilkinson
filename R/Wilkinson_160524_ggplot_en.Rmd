...
```{r, geom_bar, fig.width = 12, fig.height = 9}
...
```{r, geom_points, fig.width = 8, fig.height = 5}
...
```{r, label left, fig.width = 8, fig.height = 5}
...
```{r, points for germany, fig.width = 8, fig.height = 5}
...
``````{r, nudge, fig.width = 8, fig.height = 5}
...
```{r, labels and title, fig.width = 8, fig.height = 5}
...
```{r, correlation and separate file, fig.width = 8, fig.height = 5}
...
gd1 <- ggplot(data = Index_GDP.df, aes(x = GDP_WB, y = Index.HS, label = Country)) + theme_bw()
gd2 <- gd1 + 
...
gd5 <- gd4 + 
  scale_x_continuous(name = x.lab.2, breaks = seq(20000, 70000, by = 10000), labels = seq(20, 70, by = 10), limits = c(20000, 70000)) +
  scale_y_continuous(name = y.lab.2, breaks = c(-1.5, -1:2, 2.5), labels = c(expression("Better" %down% ""), -1:2, expression("Worse" %up% "")), limits = c(-1.5, 2.5)) + 
